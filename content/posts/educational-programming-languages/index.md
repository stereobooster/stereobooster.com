...
I believe that computer literacy should be taught the same way as we teach kids to read, write and to do the math. And those kids can become programmers if they want, to fulfill ["next blue collar job"](/content/posts/developer-is-the-next-blue-collar-job/index.md) demand.
